...
//    }
    ...
    public static function formatUserDate($date, $default = null)
    {
        ...
        if ($user != null && $date != null && $user->date_format != null) {
            ...
            return $date->format($user->date_format);
        } else {
            return $default;
        }
    }
    ...
    public static function formatUserDateTime($datetime, $default = null)
    {
        ...
        if ($user != null && $datetime != null && $user->date_format != null && $user->time_format != null) {
            ...
            return $datetime->format($user->date_format . ' ' . $user->time_format);
        } else {
            return $default;
        }
    }
